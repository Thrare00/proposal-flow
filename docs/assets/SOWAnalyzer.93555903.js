import{a as L,j as t}from"./main.aabd1649.js";import{r as x}from"./react-vendor.36470f4f.js";import{a2 as O}from"./ui-lib.59081ee4.js";let M={data:""},U=e=>typeof window=="object"?((e?e.querySelector("#_goober"):window._goober)||Object.assign((e||document.head).appendChild(document.createElement("style")),{innerHTML:" ",id:"_goober"})).firstChild:e||M,_=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,K=/\/\*[^]*?\*\/|  +/g,E=/\n+/g,v=(e,s)=>{let a="",l="",i="";for(let n in e){let r=e[n];n[0]=="@"?n[1]=="i"?a=n+" "+r+";":l+=n[1]=="f"?v(r,n):n+"{"+v(r,n[1]=="k"?"":s)+"}":typeof r=="object"?l+=v(r,s?s.replace(/([^,])+/g,d=>n.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,m=>/&/.test(m)?m.replace(/&/g,d):d?d+" "+m:m)):n):r!=null&&(n=/^--/.test(n)?n:n.replace(/[A-Z]/g,"-$&").toLowerCase(),i+=v.p?v.p(n,r):n+":"+r+";")}return a+(s&&i?s+"{"+i+"}":i)+l},g={},F=e=>{if(typeof e=="object"){let s="";for(let a in e)s+=a+F(e[a]);return s}return e},H=(e,s,a,l,i)=>{let n=F(e),r=g[n]||(g[n]=(m=>{let u=0,h=11;for(;u<m.length;)h=101*h+m.charCodeAt(u++)>>>0;return"go"+h})(n));if(!g[r]){let m=n!==e?e:(u=>{let h,b,j=[{}];for(;h=_.exec(u.replace(K,""));)h[4]?j.shift():h[3]?(b=h[3].replace(E," ").trim(),j.unshift(j[0][b]=j[0][b]||{})):j[0][h[1]]=h[2].replace(E," ").trim();return j[0]})(e);g[r]=v(i?{["@keyframes "+r]:m}:m,a?"":"."+r)}let d=a&&g.g?g.g:null;return a&&(g.g=g[r]),((m,u,h,b)=>{b?u.data=u.data.replace(b,m):u.data.indexOf(m)===-1&&(u.data=h?m+u.data:u.data+m)})(g[r],s,l,d),r},Z=(e,s,a)=>e.reduce((l,i,n)=>{let r=s[n];if(r&&r.call){let d=r(a),m=d&&d.props&&d.props.className||/^go/.test(d)&&d;r=m?"."+m:d&&typeof d=="object"?d.props?"":v(d,""):d===!1?"":d}return l+i+(r??"")},"");function T(e){let s=this||{},a=e.call?e(s.p):e;return H(a.unshift?a.raw?Z(a,[].slice.call(arguments,1),s.p):a.reduce((l,i)=>Object.assign(l,i&&i.call?i(s.p):i),{}):a,U(s.target),s.g,s.o,s.k)}let z,A,$;T.bind({g:1});let y=T.bind({k:1});function Q(e,s,a,l){v.p=s,z=e,A=a,$=l}function w(e,s){let a=this||{};return function(){let l=arguments;function i(n,r){let d=Object.assign({},n),m=d.className||i.className;a.p=Object.assign({theme:A&&A()},d),a.o=/ *go\d+/.test(m),d.className=T.apply(a,l)+(m?" "+m:""),s&&(d.ref=r);let u=e;return e[0]&&(u=d.as||e,delete d.as),$&&u[0]&&$(d),z(u,d)}return s?s(i):i}}var Y=e=>typeof e=="function",P=(e,s)=>Y(e)?e(s):e,B=(()=>{let e=0;return()=>(++e).toString()})(),G=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let s=matchMedia("(prefers-reduced-motion: reduce)");e=!s||s.matches}return e}})(),J=20,I="default",W=(e,s)=>{let{toastLimit:a}=e.settings;switch(s.type){case 0:return{...e,toasts:[s.toast,...e.toasts].slice(0,a)};case 1:return{...e,toasts:e.toasts.map(r=>r.id===s.toast.id?{...r,...s.toast}:r)};case 2:let{toast:l}=s;return W(e,{type:e.toasts.find(r=>r.id===l.id)?1:0,toast:l});case 3:let{toastId:i}=s;return{...e,toasts:e.toasts.map(r=>r.id===i||i===void 0?{...r,dismissed:!0,visible:!1}:r)};case 4:return s.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(r=>r.id!==s.toastId)};case 5:return{...e,pausedAt:s.time};case 6:let n=s.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(r=>({...r,pauseDuration:r.pauseDuration+n}))}}},V=[],X={toasts:[],pausedAt:void 0,settings:{toastLimit:J}},k={},D=(e,s=I)=>{k[s]=W(k[s]||X,e),V.forEach(([a,l])=>{a===s&&l(k[s])})},q=e=>Object.keys(k).forEach(s=>D(e,s)),ee=e=>Object.keys(k).find(s=>k[s].toasts.some(a=>a.id===e)),R=(e=I)=>s=>{D(s,e)},te=(e,s="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:s,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...a,id:(a==null?void 0:a.id)||B()}),C=e=>(s,a)=>{let l=te(s,e,a);return R(l.toasterId||ee(l.id))({type:2,toast:l}),l.id},p=(e,s)=>C("blank")(e,s);p.error=C("error");p.success=C("success");p.loading=C("loading");p.custom=C("custom");p.dismiss=(e,s)=>{let a={type:3,toastId:e};s?R(s)(a):q(a)};p.dismissAll=e=>p.dismiss(void 0,e);p.remove=(e,s)=>{let a={type:4,toastId:e};s?R(s)(a):q(a)};p.removeAll=e=>p.remove(void 0,e);p.promise=(e,s,a)=>{let l=p.loading(s.loading,{...a,...a==null?void 0:a.loading});return typeof e=="function"&&(e=e()),e.then(i=>{let n=s.success?P(s.success,i):void 0;return n?p.success(n,{id:l,...a,...a==null?void 0:a.success}):p.dismiss(l),i}).catch(i=>{let n=s.error?P(s.error,i):void 0;n?p.error(n,{id:l,...a,...a==null?void 0:a.error}):p.dismiss(l)}),e};var se=y`
from {
