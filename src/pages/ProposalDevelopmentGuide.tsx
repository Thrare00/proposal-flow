      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border-l-4 border-blue-400">
            <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">3.1 - Executive Summary Priority</h4>
            <p className="mb-2">Task: "First section of TOC must be labeled '1.0 Executive Summary' with ChatGPT prompt:</p>
            <div className="bg-white dark:bg-gray-700 p-3 rounded font-mono text-sm mb-2">
              "I want the executive summary only"
            </div>
            <p>Formatting: MLA-style header (RARE EARTH LTD | [Solicitation #])</p>
          </div>
          
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border-l-4 border-blue-400">
            <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">3.2 - FAR Clause Compliance</h4>
            <p className="mb-2">Task: "In Technical Approach sections, add:"</p>
            <div className="bg-white dark:bg-gray-700 p-3 rounded font-mono text-sm mb-2">
              /Shared/Compliance/FAR_Clauses_${currentDate}.csv:
              <table className="w-full mt-2 border-collapse">
                <thead>
                  <tr className="bg-gray-100 dark:bg-gray-800">
                    <th className="border p-2 text-left">Solicitation Reference</th>
                    <th className="border p-2 text-left">FAR Clause</th>
                    <th className="border p-2 text-left">Our Response</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border p-2">"Section 4.2"</td>
                    <td className="border p-2">FAR 52.219-8</td>
                    <td className="border p-2">"[DBE-specific compliance proof]"</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="text-sm italic">Rule: Address only clauses emphasized in solicitation (no guessing)</p>
          </div>
          
          <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md border-l-4 border-blue-400">
            <h4 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">3.3 - DBE Status Integration</h4>
            <p className="mb-2">Task: "Include once per major section:"</p>
            <div className="bg-white dark:bg-gray-700 p-3 rounded font-mono text-sm mb-2">
              "As a DOT DBE applicant and SAM.gov-verified Black and American Indian-owned business, RARE EARTH LTD aligns with [Agency]'s diversity goals under [Solicitation Section X.Y]."
            </div>
            <p className="text-sm italic">Avoid: Repeating in subsections or footers.</p>
          </div>
        </div>
      )
    },
