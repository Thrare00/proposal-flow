...
export default function StageReadinessPanel({ proposalId }) {
  ...
  if (loading) {
    return (
      <div className="rounded-xl border border-gray-200 bg-white shadow-sm px-5 py-4">
        <p className="text-sm text-gray-400 italic">Loading stage readiness…</p>
      </div>
    );
  }
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white shadow-sm">
      {/* Header */}
      <div className="flex items-center gap-2 border-b border-gray-200 px-5 py-3 text-violet-700">
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        <div className="flex items-center gap-2 text-sm font-medium text-gray-800">
          ...
          <span className="rounded-md bg-gray-50 px-2.5 py-0.5 text-gray-600 border border-gray-200">
          ...
          <div>
            ...
            <div className="space-y-1">
              {outputsPresent.map((o) => (
                <div key={o} className="flex items-center gap-2 text-sm text-emerald-700">
          ...
          <div>
            ...
            <div className="space-y-1">
              {outputsMissing.map((o) => (
                <div key={o} className="flex items-center gap-2 text-sm text-amber-700">
            ...
            <div className="space-y-1">
              {nextStageExpects.map((e, i) => (
                <div key={i} className="flex items-start gap-2 text-sm text-gray-600">
                  <Circle className="h-3 w-3 mt-0.5 flex-shrink-0 fill-gray-300" />
